  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Your {SITE_NAME} account password was successfully changed. If you made this change, no further action is needed.
        </Text>

        <Section style={highlightBox}>
          <Text style={highlightTitle}>Didn't make this change?</Text>
          <Text style={highlightText}>If you didn't update your password, please contact us immediately by replying to this email so we can secure your account.</Text>
        </Section>
