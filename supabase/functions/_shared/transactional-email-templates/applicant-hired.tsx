...
const ApplicantHiredEmail = ({ name }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Congratulations — you're joining {SITE_NAME}! 🎉</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          We're excited to welcome you to the {SITE_NAME} team! You've been selected to join our crew and we can't wait to get started.
        </Text>

        <Section style={highlightBox}>
          <Text style={highlightTitle}>Next steps</Text>
          <Text style={highlightText}>📧 Watch for an onboarding email with portal access</Text>
          <Text style={highlightText}>📋 Complete your onboarding checklist</Text>
          <Text style={highlightText}>🧹 Begin paid training with your team lead</Text>
        </Section>

        <Hr style={divider} />

        <Text style={footer}>
          Questions? Just reply to this email — we're here to help you get started.
        </Text>
...
export const template = {
  component: ApplicantHiredEmail,
  subject: "Congratulations — you're joining Olive Clean! 🎉",
